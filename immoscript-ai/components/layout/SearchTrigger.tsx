...
export function SearchTrigger() {
  return (
    <button
      ...
      className="group relative flex h-11 w-11 items-center justify-center rounded-2xl text-gray-500 transition-all active:scale-90 hover:bg-brand-50 hover:text-brand-600 dark:text-gray-400 dark:hover:bg-gray-700"
    >
